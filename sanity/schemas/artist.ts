  ...
  fields: [
    ...
    defineField({
      ...
      of: [{
        type: "object",
        fields: [
          { name: "title", type: "object", fields: [{ name: "es", type: "string", title: "Español" }, { name: "en", type: "string", title: "English" }] },
          { name: "venue", type: "string", title: "Venue" },
          { name: "location", type: "string", title: "Location" },
          { name: "year", type: "number", title: "Year" },
          { name: "type", type: "string", title: "Type", options: { list: [{ title: "Solo", value: "solo" }, { title: "Group", value: "group" }, { title: "Fair", value: "fair" }] } },
        ],
